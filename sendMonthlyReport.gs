function sendMonthlyReport() {
  ...
  var recipients = "pmichaeljordan@gmail.com"; // Replace with your recipient email addresses
  var subject = "Mike Jordan - Monthly Volunteer Hours Report for " + lastMonth.toLocaleString('default', { month: 'long', year: 'numeric' });
